    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        <div className={` flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex':'hidden sm:flex'}`}>
          ...
          <p onClick={()=>speciality === 'Pediatrician' ? navigate('/doctors/'):navigate('/doctors/Pediatrician')} className={`w-[94vw] sm:w-auto pl-3 pr-16 py-1.5 border border-r-gray-300 rounded transition-all cursor-pointer ${speciality==="Pediatricians"? "bg-indigo-100 text-black": ""}`}>Pediatrician</p>
